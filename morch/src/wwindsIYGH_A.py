...
ORNAMENT = [
    "r8 \\tuplet 3/2 { fs''16 g'' a'' } bf''2.:16",
...
MELODY = ["r4 fs'2 r4", "bf'2 r4 f'4", "r4 d'2 r4", "bf2 r2", "bf2 r2"]
...
def get_wwind_section() -> dict:
    ...
    chorus_aa_octvb = create_voice(
        IYGH_PHRASES["chorus_aa"], -12
    )  # chorus down the octave
    chorus_ab_octvb = create_voice(
        IYGH_PHRASES["chorus_ab"], -12
    )  # chorus down the octave
    chorus_ac_octvb = create_voice(
        IYGH_PHRASES["chorus_ac"], -12
    )  # chorus down the octave
    chorus_ad_octvb = create_voice(
        IYGH_PHRASES["chorus_ad"], -12
    )  # chorus down the octave
    chorus_ae_octvb = create_voice(
